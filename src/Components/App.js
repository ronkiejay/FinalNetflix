...
function App() {
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:5100/scenes")
    .then(res=>res.json())
    .then((data) => {
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:5100/scenes/featuredmovies")
    .then(res=>res.json())
    .then((data) => {
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:5100/scenes/featuredshows")
    .then(res=>res.json())
    .then((data) => {

      console.log(data.body);
      setFeaturedShows(data.body);
    })
    .catch((err)=>{
      console.log(`Error ${err}`);
    });
              ...
              <div>
                <Switch>
                  ...
                  <RecentMovieContext.Provider value={{recentMovies, setRecentMovies}}>
                    ...
                    <Route path="/?" component={MovieContainer} component={ShowsContainer}>
                      <Register />
                    </Route>
